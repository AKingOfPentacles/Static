...
namespace AlsLocomotionModeTags
{
	...
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Floating)
}
...
namespace AlsOverlayModeTags
{
	...
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon00)
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon01)
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon02)
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Weapon03)
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Voltan)
