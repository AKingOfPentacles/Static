...
namespace AlsLocomotionModeTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG(Floating, FName{TEXTVIEW("Als.LocomotionMode.Floating")})
}
...
namespace AlsOverlayModeTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG(Weapon00, FName{TEXTVIEW("Als.OverlayMode.Weapon00")})
	UE_DEFINE_GAMEPLAY_TAG(Weapon01, FName{TEXTVIEW("Als.OverlayMode.Weapon01")})
	UE_DEFINE_GAMEPLAY_TAG(Weapon02, FName{TEXTVIEW("Als.OverlayMode.Weapon02")})
	UE_DEFINE_GAMEPLAY_TAG(Weapon03, FName{TEXTVIEW("Als.OverlayMode.Weapon03")})
	UE_DEFINE_GAMEPLAY_TAG(Voltan, FName{TEXTVIEW("Als.OverlayMode.Voltan")})
